...
!
  ...
  integer :: i, j, iter, numoutside, myid
...
!$OMP PARALLEL  DEFAULT(NONE) PRIVATE(i,j,c,z,iter,myid,istart,istop) REDUCTION(+:numoutside)

myid=omp_get_thread_num()
print*, OMP_GET_NUM_THREADS()
!$OMP DO

!istart = myid*npoints/omp_get_num_threads()
!istop = istart + npoints/omp_get_num_threads() - 1
