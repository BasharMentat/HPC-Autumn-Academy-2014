...
!     
  ...
  rcoffs = rcoff*rcoff
!
  !$OMP PARALLEL DO DEFAULT(SHARED) PRIVATE(i,j,xi,yi,zi,fxi,fyi,fzi,&
  !$OMP xx,yy,zz,rd,rrd,rrd2,rrd3,rrd4,rrd6,rrd7,r148,forcex,&
  !$OMP forcey,forcez) reduction(-:vir) reduction(+:epot)& 
